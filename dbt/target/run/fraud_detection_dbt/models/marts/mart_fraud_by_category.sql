        ...
        insert into `fraud_detection`.`mart_fraud_by_category`
        ("category_id", "total_transactions", "fraud_count", "fraud_rate", "total_amount", "fraud_amount", "avg_fraud_amount")WITH category_stats AS (
    SELECT
        category_id,
