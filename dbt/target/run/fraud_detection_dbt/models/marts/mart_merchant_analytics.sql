        ...
        insert into `fraud_detection`.`mart_merchant_analytics`
        ("merchant_id", "transaction_count", "fraud_count", "fraud_rate", "total_revenue", "avg_transaction_amount", "states_count", "categories_count", "is_suspicious")WITH merchant_stats AS (
    SELECT
        merchant_id,
