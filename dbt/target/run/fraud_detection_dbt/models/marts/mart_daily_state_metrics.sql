        ...
        insert into `fraud_detection`.`mart_daily_state_metrics`
        ("transaction_date", "us_state", "transaction_count", "total_amount", "avg_amount", "p95_amount", "large_transaction_count", "large_transaction_pct")WITH daily_transactions AS (
    SELECT
        transaction_date,
        us_state,
