        ...
        insert into `fraud_detection`.`mart_customer_risk_profile`
        ("customer_id", "transaction_count", "fraud_count", "fraud_rate", "avg_amount", "total_amount", "first_transaction", "last_transaction", "risk_level")WITH customer_stats AS (
    SELECT
